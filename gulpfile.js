...
var spawn = process.platform === 'win32' ? require('cross-spawn') : require('child_process').spawn;
 ...
 * Build Jekyll site
 */
// Jekyll version has to be updated to 3.9.4 and up for incremental build to work (tested with 3.10.0)
...
/* function watch() {
  ...
  function watch() {
    return gulp.parallel(watchData, watchMarkup, watchScripts, watchStyles);
  }
